...
const SendArea = (props) => {
    const { onSendMessage, setAudioMessages, toggleSpinner, showSpinner } = props;
        ...
        <div className="msg-box">
            ...
            {(inputText && inputText.length >= 1) ? (
                ...
                <span className="btn-group">
                    <AudioRecorder showSpinner={showSpinner} setAudioMessages={setAudioMessages} toggleSpinner={toggleSpinner} onSetIsRecording={onSetIsRecording} />
                </span>
            )}
